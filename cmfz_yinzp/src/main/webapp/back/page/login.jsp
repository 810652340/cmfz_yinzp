	...
	<script type="text/javascript">
        $(function(){
            ...
            $("#captchaImage").click(function(){//点击更换验证码
                ...
                $(this).attr("src",$(this).attr('src')+"?"+tim);
...
<body>
		...
		<div class="login">
			<form id="loginForm" action="/cmfz_yinzp/admini/login" method="post" >
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/admini/code" title="点击更换验证码"/>
							</td>
						</tr>					
